...
#define BITS             16 // resolution: 10bit 12bit, or 16bit
...
#define DIP_SWITCH_PIN 28    // Digital input pin for DIP switch
#define GAIN_POT_PIN   A1    // Analog input pin for 100k potentiometer (gain adjust)
#define MIC_INPUT_PIN  A0    // Mono microphone input pin from MAX4466


// pin assignments for teensy 4.1 (stereo)
// int8_t channels0[] = {A14, A15, A2, A3, A4, A5, A6, A7, A8, A9, -1};
// int8_t channels1[] = {A16, A17, A12, A13, -1};

// pin assignment for mono
int8_t monoChannel[] = {MIC_INPUT_PIN, -1};
...
#define VOLUME_UP_PIN 3     // pin for push button for increasing audio volume
#define VOLUME_DOWN_PIN 4   // pin for push button for decreasing audio volume
#define START_PIN 2         // pin for starting a recording

// ----------------------------------------------------------------------------

DATA_BUFFER(AIBuffer, NAIBuffer, 256*256);
// stereo adc assignment
// InputADC aidata(AIBuffer, NAIBuffer, channels0, channels1);

// mono adc assignment
InputADC aidata(AIBuffer, NAIBuffer, monoChannel, nullptr); 
